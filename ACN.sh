...
echo  "=========================================" |lolcat
echo  $r "16. Hack Akun Facebook (New)${endc}";
echo  "=========================================" |lolcat
echo  $g "17. Membuat Script Deface${endc}";
echo  "=========================================" |lolcat
echo  $c "18. Auto React Facebook${endc}";
echo  "=========================================" |lolcat
echo  $r "19. Tampilan Matrix${endc}";
echo  "=========================================" |lolcat
echo  $g "20. Crack Password Hash${endc}";
echo  "=========================================" |lolcat
echo  "   00. Exit" |lolcat
echo ""
echo  "╭─MrYM" |lolcat
...
17) echo  "NB :Jika Script nya sudah selesai dibuat,ketik" |lolcat
